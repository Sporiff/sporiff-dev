...
date: 2020-04-19T01:23:40.000Z
tags: git, website, tech, bot, lisp
image: https://rootkey.fra1.cdn.digitaloceanspaces.com/images/post_images/git.webp
summary: I've been meaning to improve the way I deploy this website for a little while now. Since I stopped using Netlify in favour of a more bare-bones approach, there has been a lot of manual/ugly work involved with the process of updating this website and posting from its RSS feed to my Mastodon feed.
---
...
[git]: https://rootkey.fra1.cdn.digitaloceanspaces.com/images/post_images/git.webp
