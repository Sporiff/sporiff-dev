...
Following on from my [previous post][elementary-juno] I have been using the latest release of elementaryOS for the last few days and having a poke around at their documentation. I've been really impressed by the relative simplicity of approach applications seem to have on the OS and the documentation. Having followed through a bit, it looks like the ideal platform for me to actually try and make my first app on.
...
As a quick update, I've added thermy to my [GitHub][thermy-repo] as (very much) a WIP. As the app is updated when I have time to spare I'll push it straight there. Wouldn't expect too much, though.

{/*Article links*/}

[elementary-juno]: ../2018/elementary-juno"

{/*External links*/}

[thermy-repo]: https://github.com/Sporiff/thermy
