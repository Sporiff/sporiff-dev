...
<div class="relative h-0 overflow-hidden pb-[56.25%] pt-[30px]">
  <iframe
    class="absolute top-0 left-0 h-full w-full border-0"
    width="560"
    height="315"
    src="https://www.youtube.com/embed/krRFlzwnw3U?clip=Ugkxn_le91Jce7u3I-B7RBjYcTvP-sDO42PB&amp;clipt=EOukBBijzAQ"
...
Anyway, once I got my licensing issue sorted out I set about removing the usual guff that gets installed. To Dell's credit not much was theirs, most was just plain old Microsoft gunk such as that Solitaire game they want me to pay a subscription fee for (lolwot). At this point I turned to [winget](https://github.com/microsoft/winget-cli) and started installing my normal packages. Given all my data is backed up on the cloud the actual setup of the machine at this point took only a few minutes.
...
Okay, so this machine is not exactly beefy, but what can one expect in a 1,2kg machine? 16GB of RAM is plenty to get done what I usually do in a day and the CPU is barely registering load most of the time. I can play most of the games I played before including [Sauerbraten](http://sauerbraten.org/) (a.k.a. the only FPS that matters) at a good framerate, so I'm pretty happy with that.
