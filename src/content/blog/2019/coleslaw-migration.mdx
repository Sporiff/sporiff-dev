...
![The Coleslaw logo](/images/coleslaw.webp)
...
As part of this new experience I started looking into ways I could use Lisp in my everyday life. I quickly came across [Coleslaw](https://github.com/coleslaw-org/coleslaw) as a recommended static site generator and decided to give it a go. There's a bit of a learning curve to it, and it doesn't really have the simplicity and wider appeal of alternatives such as Hugo and Pelican, but for the sort of thing I'm doing it works wonderfully. The config is a joy to write (reminds me a lot of configuring my Guix system settings) and everything can be easily chopped and changed without too much worry. I can highly recommend it.
