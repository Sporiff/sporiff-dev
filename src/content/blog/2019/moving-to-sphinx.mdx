...
pubDate: 2019-05-08T23:00:00.000Z
tags:
  - blog
  - site
  - website
  - sphinx
description: I've made a few changes to this website. Well, not really a few changes, more like a complete overhaul. I was getting a bit bored of using Hugo/Markdown and decided to challenge myself to using Sphinx and rST instead.
---
...
- Move to [Sphinx](https://sphinx-doc.org)
- Enable [Ablog](https://ablog.readthedocs.io)
- Move away from Github to Gitlab
- Get [Netlify CI](https://netlify.com) working with the new setup
