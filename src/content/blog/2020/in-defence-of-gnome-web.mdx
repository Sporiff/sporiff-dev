...
So you probably already know that [Mozilla recently went bang](https://www.theregister.com/2020/08/11/mozilla_staff_layoffs_products_revenue/) and fired 25% of its workforce before announcing that whoops lol actually we are [still going to be able to feed the hungry fox this year](https://www.theregister.com/2020/08/14/mozilla_google_search/). Among the teams affected were the servo developers, a lot of the threat response team, and (I believe) the entirety of the team behind MDN: the [only good resource for web development don't @ me](https://developer.mozilla.org/). As you can imagine this has led to quite the tizzy as people have puzzled about what exactly this means for the Firefox browser, Mozilla as an organisation, and the future of browsing and, indeed, the web as a whole.
...
- General website rendering and support is pretty good. Ironically, [elementary's website](https://elementary.io) doesn't work in the latest version. It just crashes. Whoops. But apart from that I've had no issues

The biggest omission I've come across is the lack of extension support, which apparently they would like to support through the [WebExtensions API](https://wiki.gnome.org/Apps/Web/Docs/FrequentlyAskedQuestions). This is a pretty glaring hole for some people, I'm sure, but this brings me to my first point:
...
I've been using GNOME Web for a while now alongside Firefox and have started using it more following this news. It's not perfect, it lacks some things I really liked about Firefox, but I do like the fact that my computer now doesn't make the sound of a poorly maintained Boeing 747 during my daily visit to [the hamster dance website](https://hamster.dance/hamsterdance/).
